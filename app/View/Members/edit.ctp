		...
		<div class="heading">	
			...
			<?php 
				if ($member['Member']['id'] == $getuser['member_id']) {
					echo $this->Html->link('My Profile', array('controller' => 'members', 'action' => 'profile/'. $getuser['member_id'])); ?>&nbsp;>&nbsp; Edit<?php
				}
				else {
					echo $this->Html->link('Members', array('controller' => 'members', 'action' => 'index')); ?>&nbsp;>&nbsp;<?php
					echo $this->Html->link($member['Member']['member_gname']." ".$member['Member']['member_mname']." ".$member['Member']['member_fname'], array('controller' => 'members', 'action' => 'detailedmember/'. $member['Member']['id'])); ?>&nbsp;>&nbsp; Edit<?php
				}
			?>
			</p>
		...
		<div class="inputform">
			...
			<div id="submitButtons">
				<button type="Submit" class="button save">Confirm Edit<?php echo $this->Form->end(); ?></button>
					...
					<?php 
						echo $this->Html->link('Cancel', array('controller' => 'members', 'action' => 'detailedmember/'. $member['Member']['id']), array('class' => 'button back'));
					?>
